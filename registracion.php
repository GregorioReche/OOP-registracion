            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="registracion.php">
                        ...
                        <!-- <div class="input-group">
                            <input class="input--style-3" type="date" placeholder="Birthdate" name="birthday" value="<?=$fechaDefault?>">
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="gender">
                                    ...
                                    <!-- Lo que pregunto en cada opcion es si el form ya fue enviado y si la opcion seleccionada es la que estoy por imprimir. Si ese es el caso la marco como SELECTED !-->
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Email" name="email" value="<?=$emailDefault?>">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Password" name="password">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Password Confirmation" name="cpassword">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Phone" name="phone" value="<?=$telefonoDefault?>">
                        </div>
                        <div class="p-t-10">
